...
Private Function DoDiff_(file1 As FileItem_, file2 As FileItem_, ignoreNum As Boolean, tolernce As Long)
    ...
    With resultbook.Sheets(1)
        ...
        With .Cells(5, 1)
            .Offset(0, 0) = "Ëáíl1": .Offset(0, 1) = 1000
            .Offset(0, 0).HorizontalAlignment = xlRight
            Set th1 = .Offset(0, 1)
            
            .Offset(0, 2) = "Ëáíl2": .Offset(0, 3) = 0.00001
        ...
        With .Cells(2, 1)
            .Offset(0, 0) = "á@": .Offset(0, 0).HorizontalAlignment = xlRight: .Offset(0, 1) = file1.Path
